...
public class ChemicaFuelTypes {
    ...
    public static FuelType HIGH_CETANE_DIESEL;
    ...
    public static void registerFuelTypes() {
        ...
        TagKey<Fluid> highCetaneTag = TagKey.create(
                BuiltInRegistries.FLUID.key(),
                ResourceLocation.fromNamespaceAndPath("c", "high_cetane_diesel")
        );
        ...
        HIGH_CETANE_DIESEL = new FuelType.Builder(Chemica.asResource("high_cetane_diesel"))
                .speed(1.8f)
                .efficiency(1.0f)
                .stress(2.1f)
                .registerAndAssign(highCetaneTag);
